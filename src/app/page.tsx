					...
					<div className="grid grid-cols-1 gap-3 md:grid-cols-3">
						<StatCard
							...
							value={
								loading
									? "..."
									: `${dashboard?.metrics.patientsTotal ?? 0}`
							}
						...
						<StatCard
							...
							value={
								loading
									? "..."
									: `${dashboard?.metrics.assessmentsToday ?? 0}`
							}
						...
						<div className="mt-3 space-y-2">
							{recentItems.slice(0, 3).map((item) => {
								...
								const label = Array.isArray(
									...
									? item.scoring_results[0]?.diagnosis
											?.primaryDiagnosis?.label
									: item.scoring_results?.diagnosis
											?.primaryDiagnosis?.label;
