    ...
    <>
      <aside className="hidden xl:flex xl:w-72 xl:flex-col xl:gap-3 border-r border-slate-200/60 bg-white/80 backdrop-blur-md p-5 shadow-[4px_0_24px_rgba(0,0,0,0.01)]">
        <div className="flex items-center gap-3 border-b border-slate-100 pb-5 mb-5">
          <div className="h-11 w-11 rounded-[14px] bg-linear-to-br from-primary to-blue-600 flex items-center justify-center text-white font-bold text-lg shadow-sm shadow-blue-500/20">
            H
          </div>
          <div>
        ...
        <div className="space-y-1.5 flex-1">
          {items.map((item) => {
            ...
            return (
              ...
              >
                <Icon
                  className={`w-5 h-5 transition-colors ${isActive ? "text-primary" : "text-slate-400 group-hover:text-slate-600"}`}
                />
