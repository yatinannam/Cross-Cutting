...
export default function ActionButton({ 
	...
	const variants = {
		primary: "bg-primary text-white hover:bg-blue-600 shadow-sm border border-transparent shadow-blue-500/20 disabled:bg-blue-300 disabled:shadow-none",
		secondary: "bg-slate-100 text-slate-800 hover:bg-slate-200 border border-transparent disabled:bg-slate-50 disabled:text-slate-400",
		ghost: "bg-white border border-slate-200 text-slate-700 hover:bg-slate-50 hover:border-slate-300 disabled:bg-slate-50 disabled:text-slate-400",
	};
